...
const int	EME_MODE_TRAFIC	= 1;		// Mx
const int	EME_COMPRESSEUR	= 2;		// Zx
const int	EME_MODE_FONCT	= 3;		// Bx
const int	EME_FREQUENCE	= 4;		// Fx
const int	EME_NIVEAU		= 5;		// Hx
const int	EME_CANAL_POSI	= 6;		// Px
const int	EME_CANAL_LECT	= 7;		// Cx
const int	EME_OPTION		= 8;		// OPxy
const int	EME_TEST		= 9;		// TST
const int	EME_ETAT_LOGI	= 10;		// XX
const int	EME_MODE_LOCAL	= 11;		// LOC/RMT/DOUBLE
const int	EME_DATA_OUT	= 12;		// Y
const int	EME_INCIDENT	= 13;		// Jxy
const int	EME_INFO		= 14;		// T
...
***************************************************************************	*/
class CEquip1225:public CEquip
{
/* **************************************************************************
DONNEES INTERNES
***************************************************************************	*/
...
TRAITEMENT:		Modifie le mode de trafic et eventuellement génère une TS
***************************************************************************	*/
	int ChangeModeTrafic(int num_canal,int mode,BOOL genere_TS);
