/* **************************************************************************
FICHIER :	Eqp_1236.CPP		 			AUTEUR : PhB
DATE DE CREATION : 	13/12/96			DERNIERE MODIFICATION : 14/02/97
VERSION :	1.0
ROLE :		Implémentation de la classe CEquip1236
***************************************************************************	*/
#include "stdafx.h"
#include <stdio.h>
...
***************************************************************************	*/
CEquip1236::CEquip1236(int idx):CEquip(idx)
{
	int		i;
...
void CEquip1236::Allocation()
{
	...
	if(ihm == NULL) ihm = new CDlg1236;
	ihm->Associe(this);
	ihm->Create(F7_IDD_TRC1236_FF,glob_ihm);
...
***************************************************************************	*/
BOOL CEquip1236::Charge_Contexte(char *fichier)
{
	int 	i,iResult;
...
***************************************************************************	*/
BOOL CEquip1236::Sauve_Contexte(char *fichier)
{
	int 	i,iResult;
...
int CEquip1236::ChangeLocal(int valeur,BOOL genere_TS)
{
	int 	iResult = valeur;
...
// Mode de trafic *********************************************
int CEquip1236::ModeTrafic(int num_canal) const
{
	int		iResult;
...
int CEquip1236::ChangeModeTrafic(int num_canal,int valeur,BOOL genere_TS)
{
	int		iResult = valeur;
	...
	if(valeur >=0 && valeur <=5)
	{
		EnterCriticalSection(&crit);
			...
			l11 = (valeur == 2) || (valeur == 3) || (valeur == 4);
		...
		if(genere_TS)
		{
			((CProto1236*)proto)->ChangeCanalLecture(num_canal);
			proto->AjouterTS(NULL,EME_1236_MODE_TRAFIC);
			proto->AjouterTS(NULL,EME_1236_COMPRESSEUR);
		}
	}
...
// Compresseur *********************************************
int CEquip1236::Compresseur() const
{
	int		iResult;
...
int CEquip1236::ChangeCompresseur(int valeur,BOOL genere_TS)
{
	int		iResult = valeur;
...
int CEquip1236::Fonction(int num_canal) const
{
	int		iResult;
...
int CEquip1236::ChangeFonction(int num_canal,int valeur,BOOL genere_TS)
{
	char	buf[80];
	...
	if(valeur >=0 && valeur <=9)
	{
		...
		{
			((CProto1236*)proto)->ChangeCanalLecture(num_canal);
			proto->TraiteTS(EME_1236_MODE_FONCT,buf);
			buf[2]='?';
			proto->AjouterTS(buf,EME_1236_MODE_FONCT);
			...
			else proto->AjouterTS(NULL,EME_1236_MODE_FONCT);
		}
	}
	else
	{
...
int CEquip1236::ChangeIncident(int valeur,BOOL genere_TS)
{
	int		iResult = valeur;
	...
	if(valeur >=-1 && valeur <=999)
	{
		...
		if(genere_TS)
		{
			proto->AjouterTS(NULL,EME_1236_INCIDENT);
		}
	}
	else
	{
...
// Frequence ******************************************
long CEquip1236::Frequence(int num_canal) const
{
	long		iResult;
...
long CEquip1236::ChangeFrequence(int num_canal,long valeur,BOOL genere_TS)
{
	char		buf[80];
	long	lResult = valeur;
	...
	if(valeur>=400000 && valeur <= 29999990)
	{
		...
		{
			((CProto1236*)proto)->ChangeCanalLecture(num_canal);
			proto->TraiteTS(EME_1236_FREQUENCE,buf);

			buf[(int)strlen(buf)-1] = '<';
			proto->AjouterTS(buf,EME_1236_FREQUENCE);
			proto->AjouterTS(NULL,CDE_TEMPO_SEQ);
...
// Niveau *********************************************
int CEquip1236::AutoNiveau() const
{
	int		iResult;
...
int CEquip1236::ChangeAutoNiveau(int valeur)
{
	int		iResult = valeur;
...
int CEquip1236::ChangeNiveau(int valeur,BOOL genere_TS)
{
	int		iResult = valeur;
...
*/
		...
		if(genere_TS)
		{
			proto->AjouterTS(NULL,EME_1236_NIVEAU);
		}
	}
	else
	{
...
int CEquip1236::ChoixNiveau() const
{
	int		iResult;
...
int CEquip1236::ChangeChoixNiveau(int valeur,BOOL genere_TS)
{
	int		iResult = valeur;
...
int CEquip1236::ChangeCanal(int valeur,BOOL genere_TS)
{
	int 	iResult = valeur;
	char	buf[80];
	...
	if(valeur>=0 && valeur <= 99)
	{
		...
		if(genere_TS)
		{
			proto->TraiteTS(EME_1236_CANAL_POSI,buf);

			buf[(int)strlen(buf)-1] = '<';
			proto->AjouterTS(buf,EME_1236_CANAL_POSI);
			proto->AjouterTS(NULL,CDE_TEMPO_SEQ);
...
int CEquip1236::MemoriseCanal(int valeur,BOOL genere_TS)
{
	int 	iResult = valeur;
	...
	if(valeur>=1 && valeur <= 99)
	{
		...
		if(genere_TS)
		{
			((CProto1236*)proto)->ChangeCanalLecture(valeur);
			proto->AjouterTS(NULL,EME_1236_CANAL_LECT);
		}
	}
	else
	{
...
int CEquip1236::ChangeTest(int valeur,BOOL genere_TS)
{
	int 	iResult = 0;
	...
	if(genere_TS)
	{
		proto->AjouterTS(NULL,EME_1236_TEST);
	}
...
int CEquip1236::ChangeInfo(int valeur,BOOL genere_TS)
{
	int 	iResult = valeur;
...
// mode L11
int CEquip1236::L11() const
{
	return 0;
}

// mode SPIN
int CEquip1236::Spin() const
{
	return 0;
}
int CEquip1236::ChangeSpin(int valeur,BOOL genere_TS)
{
	return 0;
}
